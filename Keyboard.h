...
void getkeys_down(unsigned char key,int x,int y)
{
	...
	case 13  :   State = LOGO ;    break;
	case 32  : { State = MAIN_MENU ; ProcessMenu(); } break;

	case 'g' : State = STARTGAME; Data::lives = 3; Data::id = 1; break;

	case 'l' : State = LEVELCOMPLETE; break;
	case 'n' : State = GAME_OVER; break;
	case 'r' : State = RESETGAME; break;
